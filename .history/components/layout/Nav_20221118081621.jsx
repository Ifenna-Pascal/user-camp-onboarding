...
function Nav() {
  ...
  return (
    <div className="lg:sticky absolute top-0 w-full shadow-sm mb-4 z-50 px-6 lg:px-0 bg-white">
      <nav className="w-full lg:py-6 py-6 flex items-center  lg:max-w-[1450px] lg:mx-auto justify-between">
        <Link href="/">
          {" "}
