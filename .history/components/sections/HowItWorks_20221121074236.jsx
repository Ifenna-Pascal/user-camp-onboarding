      ...
      <div className="grid p-6 grid-cols-1 lg:grid-cols-2">
        <div className="lg:flex hidden items-center  justify-center flex-col">
          ...
          <StepProcess
            ...
            content={`A variety of seminarse centered at improving our relationship with God, down to career exploits, academic excellence and lot's more exists at every section. Every timing has it's special offers  `}
          />
          <StepProcess
            current={current}
            active={2}
