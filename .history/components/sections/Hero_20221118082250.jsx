...
function Hero() {
  return (
    ...
    >
      <div className="w-full flex  lg:-mt-8 lg:items-start items-center flex-col lg:justify-center  h-full">
        ...
        <p className="text-lg lg:max-w-[600px] text-gray-700 py-3 text-center lg:text-left leading-[30px] lg:leading-[40px] font-poppins lg:pr-[50px]">
