...
function Hero() {
  return (
    ...
    >
      <div className="w-full flex  lg:-mt-8 items-start  flex-col justify-center  h-full">
        <h1 className="text-3xl lg:text-6xl text-gray-800 text-center lg:text-left lg:leading-[75px] font-semibold font-sono">
