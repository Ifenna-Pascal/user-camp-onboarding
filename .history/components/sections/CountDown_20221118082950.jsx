...
function CountDown() {
  ...
  return (
    <div>
      {display && (
        <div className="w-full flex  justify-center lg:pt-36 pt-6 lg:pb-24 md:max-w-[900px] mx-auto  gap-4 px-4">
...
const TimeDisplay = ({ time, text }) => (
  <div className=" bg-[#e5e5e5] flex items-center justify-center p-8 w-[60px] lg:w-[180px] mr-6 rounded-md  lg:h-[150px] relative shadow-xl">
    ...
    <div className="flex flex-col items-center">
      <h1 className="text-gray-800 text-6xl mb-2 font-semibold font-montserat block">
        {time}
      </h1>
