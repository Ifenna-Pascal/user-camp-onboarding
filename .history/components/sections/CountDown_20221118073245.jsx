...
function CountDown() {
  ...
  return (
    <div>
      {display && (
        <div className="w-full flex  justify-center pt-24 pb-12 md:max-w-[900px] mx-auto  gap-4 px-4">
          {/* <CircularProgressbar
            value={days}
            text={`${days}`}
            styles={buildStyles({
...
const TimeDisplay = ({ time, text }) => (
  <div className=" bg-[#e5e5e5] flex items-center justify-center p-8 w-[180px] mr-4 rounded-md  h-[150px] shadow-inner">
