...
function CountDown() {
  ...
  return (
    <div>
      {display && (
        <div className="w-full flex  justify-center mp-4 lg:pt-36 pt-6 pb-12 lg:pb-24 md:max-w-[900px] lg:mx-auto  gap-4 px-4">
...
const TimeDisplay = ({ time, text }) => (
  <div className=" bg-[#e5e5e5] flex items-center  justify-center p-8 w-[80px] lg:w-[180px] mr-2 lg:mr-6 rounded-md h-[80px] lg:h-[150px] relative shadow-lg">
