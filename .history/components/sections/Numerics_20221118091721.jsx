...
function Numerics() {
  return (
    <div className="bg-gray-900 rounded-md flex lg:flex-row flex-col justify-center my-12 min-h-[600px] lg:min-h-[250px] w-full">
      <div className="lg:max-w-[1100px] flex lg:flex-row flex-col items-center w-full justify-between mx-auto">
