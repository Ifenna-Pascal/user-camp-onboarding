...
const TimeDisplay = ({ time, text }) => (
  <div className=" bg-[#e5e5e5] flex items-center mx-5 lg:mx-0 justify-center p-8 w-[80px] lg:w-[180px] mr-2 lg:mr-6 rounded-md h-[80px] lg:h-[150px] relative shadow-xl">
