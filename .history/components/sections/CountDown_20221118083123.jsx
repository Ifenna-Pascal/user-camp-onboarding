...
function CountDown() {
  ...
  return (
    <div>
      {display && (
        <div className="w-full flex  justify-center lg:pt-36 pt-6 pb-24 md:max-w-[900px] mx-auto  gap-4 px-4">
...
const TimeDisplay = ({ time, text }) => (
  <div className=" bg-[#e5e5e5] flex items-center justify-center p-8 w-[60px] lg:w-[180px] mr-2 lg:mr-6 rounded-md h-[80px] lg:h-[150px] relative shadow-xl">
    {/* <div className="absolute top-[50%] w-full bg-gray-600 h-[2px]"></div> */}
    <div className="bg-white absolute -left-3 w-2 lg:w-6  h-2 lg:h-6 top-[43%] "></div>
    <div className="bg-white absolute -right-3 w-2 lg:w-6  h-2 lg:h-6 top-[43%] "></div>
    <div className="flex flex-col items-center">
      <h1 className="text-gray-800 text-3xl lg:text-6xl mb-2 font-semibold font-montserat block">
        {time}
      </h1>
      <p className="text-center block  font-sono">{text}</p>
    </div>
  </div>
);
