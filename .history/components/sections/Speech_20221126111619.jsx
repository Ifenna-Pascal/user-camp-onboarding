...
function Speech() {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 pt-12 items-center justify-center ">
      ...
      <div>
        <p className="text-left block text-xl cursor-pointer font-poppins  leading-[30px] text-gray-500 py-4 px-2">
          {p.substring(0, 464)} ...{" "}
          <span className="font-semibold font-sono text-gray-600">
            read more
          </span>
        </p>
      </div>
