  ...
  return (
    ...
    >
      <div className="w-full flex  lg:-mt-8 lg:items-start items-center flex-col justify-center h-full">
        ...
        <p className="text-base lg:max-w-[600px] text-gray-700 py-3 text-center lg:text-left leading-[30px] lg:leading-[30px] font-poppins px-4 lg:px-0 lg:pr-[50px]">
