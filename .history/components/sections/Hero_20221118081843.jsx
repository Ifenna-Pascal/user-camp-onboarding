...
function Hero() {
  return (
    <div id="home" className="lg:h-[80vh] h-screen   grid grid-cols-2">
      <div className="w-full lg:flex flex-col -mt-8 items-start  flex-col justify-center  h-full">
        <h1 className="text-6xl text-gray-800 leading-[75px] font-semibold font-sono">
