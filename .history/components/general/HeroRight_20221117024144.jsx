...
function HeroRight() {
  return (
    <div className="grid grid-cols-3 h-full w-full  gap-6 grid-row-5">
      ...
      {/* <div className="grid  gap-y-4h-full w-full h-full row-span-5  col-span-1"> */}
      <div className="row-start-1 h-full w-full row-span-1 col-start-2 col-span-1">
        <ImageBox color="bg-red-400" />
      </div>
      <div className="row-start-2 row-span-2h-full w-full col-start-2 col-span-1">
        <ImageBox color="bg-green-400" />
      </div>
      <div className="row-start-4 col-start-2 col-span-1h-full w-full row-span-1">
        <ImageBox color="bg-purple-400" />
      </div>
      {/* </div> */}
      {/* <div className="grid  gap-y-4h-full w-full h-full row-span-5"> */}
