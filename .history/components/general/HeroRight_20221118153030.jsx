...
function HeroRight() {
  return (
    <div className="grid grid-cols-3 lg:px-8 px-4 mt-8 lg:my-0 pr-0  w-full gap-4 grid-row-7">
      ...
      <div class="w-full row-start-4 row-span-7 col-span-1 col-start-1 row-end-4">
        <img
