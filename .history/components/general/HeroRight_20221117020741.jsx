...
function HeroRight() {
  return (
    <div className="grid grid-cols-3  w-full h-full gap-4 grid-row-5">
      ...
      <div className="grid grid-cols-5 gap-y-4 w-full h-full row-span-5 bg-purple-400 col-span-1">
      ...
      <div className="grid grid-cols-5 gap-y-4 w-full h-full bg-yellow-300 row-span-5">
