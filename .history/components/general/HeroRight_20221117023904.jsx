...
function HeroRight() {
  return (
    <div className="grid grid-cols-3  w-full h-full gap-6 grid-row-5">
      ...
      <div className="row-start-4 col-start-2 col-span-1 w-full row-span-1">
        <ImageBox color="bg-purple-400" />
      </div>
      {/* </div> */}
      {/* <div className="grid  gap-y-4 w-full h-full row-span-5"> */}
      <div className="row-start-1 col-start-3  row-span-1">
        <ImageBox color="bg-blue-400" />
      </div>
      <div className="row-start-3 col-start-3 col-span-1 row-span-3">
        <ImageBox color="bg-green-400" />
      </div>
